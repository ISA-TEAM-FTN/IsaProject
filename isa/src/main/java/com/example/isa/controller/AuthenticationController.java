...
public class AuthenticationController {
	...
	@PostMapping("/signup")
	public ResponseEntity<User> addUser(@RequestBody RegisterDto registerDto, UriComponentsBuilder ucBuilder) {
		User existUser = this.userService.findByUsername(registerDto.getUsername());

		if (existUser != null) {
			throw new ResourceConflictException(registerDto.getId(), "Username already exists");
		}
